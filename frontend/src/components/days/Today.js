        ...
        const moveTask = (_id, newDay) => {
            axios.put(`http://127.0.0.1:8000/tasks/move/${_id}/${newDay}`).then(res => {
                ...
                if (res.data.status === "ok"){
                    ...
                    this.setState({alert: "Unable to move task"});
            ...
            <div className = "container">
                ...
                <Modal show={this.state.show} onHide={handleClose}>
                    ...
                    <Modal.Body>
                        ...
                        <div className='row'>
                            <div className='col'>
                                <div className='info'>
                                    ...
                                    <h6>{this.state.currentTaskPrioirty}</h6>
                                </div>
                            </div>
                            <div className='col'>
                                <div className='info'>
                        ...
                        <div className='row'>
                            <div className='col'>
                                <div className='info'>
                                    ...
                                    <h4>Priority</h4>
                                    <h6>{10-this.state.currentTaskPrioirty}/10</h6>
                                </div>
                            </div>
                            <div className='col'>
                                <div className='info'>
                     ...
                     <br></br>
                      <div className='row'>
                        <Button className='btn btn-warning' onClick ={() => openChangeModal()}>Move Target Day</Button>
                 </div> 
                 <br></br>
                 <div className='row'>
                ...
                <Modal show={this.state.show2} onHide={handleClose2}>
                    ...
                    <Modal.Body>
                        <div>
                            <center>
                            <h6>Current Target Day: {this.state.currentTaskTargetDate}</h6>
                            <h6>Choose a New Target Day:</h6>
                ...
                <center>
                <h4>{this.state.noTasksMessage}</h4>
                <br></br>
                </center>
              </div>
            </div>
